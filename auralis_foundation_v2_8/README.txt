AURALIS BEACON FOUNDATION V2.8
...
V2.8:
- Fixed desktop/laptop login page fit so the lower feature cards remain visible without browser zooming out.
- Reduced login panel footprint on medium-height screens.
- Scaled the demo phone card instead of cutting off the feature cards.
- Added bottom breathing space while preserving the mobile login/auth visibility fixes from V2.5.

V2.8:
- Restored visible top breathing space above the login panel.
- Rebalanced short-height laptop login layout without hiding the lower feature cards.
- Centered the small Auralis protected-phone demo card within the left login column.
- Preserved V2.7 fit improvements, V2.6 mobile polish, and V2.5 auth visibility fix.