AURALIS BEACON FOUNDATION V2.6 Refit
...
V2.6 REFIT:
- This build starts again from V2.6, not V2.7 or V2.8.
- Only the login-page fit was adjusted.
- Preserves V2.6 mobile colour/design, V2.6 tracker page, V2.6 bottom navigation and V2.6 auth visibility fix.
- Adds enough top/bottom breathing space and reduces only excess vertical spacing on laptop-height screens.