AURALIS BEACON FOUNDATION V2.9
...
V2.9:
- Started from V2.6 again.
- Fixed login-page fit by placing the phone preview and feature cards in one compact row on laptop-height screens.
- Preserved V2.6 mobile colour/design, tracker layout, bottom navigation, and auth visibility fix.
- Large desktop screens keep the relaxed original V2.6-style layout.